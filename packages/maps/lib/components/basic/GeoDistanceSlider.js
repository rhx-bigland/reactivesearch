...
var GeoDistanceSlider = function (_Component) {
	...
	GeoDistanceSlider.prototype.componentWillMount = function componentWillMount() {
		...
		if (this.props.selectedValue && this.props.selectedValue.location) {
			this.setState({
				...
				_this2.getCoordinates(_this2.props.selectedValue.location, function () {
					if (_this2.props.selectedValue.distance) {
						_this2.setDistance(_this2.props.selectedValue.distance);
					}
				});
			});
			...
			this.setState({
				...
				_this2.getCoordinates(_this2.props.defaultSelected.location, function () {
					if (_this2.props.defaultSelected.distance) {
						_this2.setDistance(_this2.props.defaultSelected.distance);
					}
				});
			});
		}
	...
	GeoDistanceSlider.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
		var _this3 = this;
		...
		if (nextProps.defaultSelected && nextProps.defaultSelected.distance && nextProps.defaultSelected.location && !(0, _helper.isEqual)(this.props.defaultSelected, nextProps.defaultSelected)) {
			this.setValues(nextProps.defaultSelected);
		} else if (nextProps.selectedValue && nextProps.selectedValue.distance && nextProps.selectedValue.location && !(0, _helper.isEqual)(this.state.currentLocation, nextProps.selectedValue.location)) {
